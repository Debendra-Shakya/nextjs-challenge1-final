...
const Form = () => {
  ...
  const INITIAL_TOP_NUMBER = useSelector((store) => store.form.topNumber);
  ...
  return (
    <Section inverse="a" padding="0">
      <Forms onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.country && <Error>Country name must be required</Error>}
        {errors.topNumber && <Error>Numbers must be between 0-50</Error>}
